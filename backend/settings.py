...
# Configuración de Simple JWT (opcional)
from datetime import timedelta
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=2),
    'REFRESH_TOKEN_LIFETIME': timedelta(days=1),  # si usas refresh
...
# Configurar archivos estáticos y medios
STATIC_URL = '/static/'
